...
- Catalog prices are final Saudi VAT-inclusive amounts, not pre-tax prices. Domestic invoices extract VAT from the final amount; verified international sales keep that final amount without charging Saudi VAT. Apply finalized company-contract terms to new linked invoices, without recalculating historical invoices.
