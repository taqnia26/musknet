...
export const shipmentsTable = pgTable("shipments", {
  ...
  destinationStreet: text("destination_street"),
  destinationBuildingNumber: text("destination_building_number"),
  destinationPostalCode: text("destination_postal_code"),
  destinationAdditionalDetails: text("destination_additional_details"),
