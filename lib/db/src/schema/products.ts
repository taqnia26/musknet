...
export const productsTable = pgTable("storefront_products", {
  ...
  displayNameAr: text("display_name_ar").notNull().default(""),
  displayNameEn: text("display_name_en").notNull().default(""),
  invoiceNameAr: text("invoice_name_ar").notNull().default(""),
  invoiceNameEn: text("invoice_name_en").notNull().default(""),
