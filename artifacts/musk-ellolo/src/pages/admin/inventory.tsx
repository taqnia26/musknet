...
const emptyCreate: CreateForm = { nameAr: '', nameEn: '', displayNameAr: '', displayNameEn: '', invoiceNameAr: '', invoiceNameEn: '', descriptionAr: '', descriptionEn: '', sku: '', categoryId: '', price: '0', openingQuantity: '0', openingUnitCost: '', reorderPoint: '5', targetStockQuantity: '20' };
